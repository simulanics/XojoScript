...
g++ -static -m64 -o xojoscript.exe xojoscript.cpp xojoscript.res -Lc:/xojodevkit/x86_64-w64-mingw32/lib/libffix64 -lffi -O3 -march=native -mtune=native 2> error.log
